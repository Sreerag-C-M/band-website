...
export default function Home() {
  return (
    <main className="relative bg-[#050508] text-white selection:bg-accent-red/30 selection:text-white">
      {/* Dynamic Background */}
      <ParticlesBackground />
      ...
      {/* Aesthetic Overlays */}
      <div className="fixed inset-0 pointer-events-none z-[100] border-[20px] md:border-[40px] border-accent-red/2 opacity-[0.03]" />
