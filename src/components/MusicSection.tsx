...
export const MusicSection = () => {
    ...
    return (
        <section id="music" className="py-24 px-4 bg-[#0a0a0f] border-y border-white/5 relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-accent-purple/5 blur-[150px] pointer-events-none" />
            <div className="absolute bottom-1/2 right-0 w-[400px] h-[400px] bg-accent-blue/5 blur-[150px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    >
                        The <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-purple to-accent-blue neon-text-purple">Discography</span>
                    </motion.h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center min-h-[500px]">
                    ...
                    <div className="relative h-[400px] md:h-[500px] flex items-center justify-center">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className={cn(
                                                ...
                                                isCenter ? "neon-border-purple border-accent-purple/30" : "border-white/5"
                                            )}>
                                                <Image
                                                    src={album.image}
                                                    alt={album.title}
                                                ...
                                                {isCenter && (
                                                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity backdrop-blur-[2px]">
                                                        <motion.button
                                                            ...
                                                            whileTap={{ scale: 0.9 }}
                                                            className="w-20 h-20 bg-accent-purple rounded-full flex items-center justify-center text-white shadow-[0_0_30px_rgba(168,85,247,0.5)]"
                                                        >
                        ...
                        <div className="absolute bottom-[-60px] flex gap-4 lg:hidden">
                            <button onClick={prev} className="w-12 h-12 glass rounded-full flex items-center justify-center hover:bg-accent-purple/20 transition-colors"><ChevronLeft /></button>
                            <button onClick={next} className="w-12 h-12 glass rounded-full flex items-center justify-center hover:bg-accent-purple/20 transition-colors"><ChevronRight /></button>
                        </div>
                    </div>
                            ...
                            >
                                <div>
                                    <motion.span
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                                        className="text-accent-cyan font-bold tracking-[0.4em] text-xs uppercase block mb-2"
                                    >
                                        Active Selection
                                    </motion.span>
                                    ...
                                    <div className="flex flex-wrap gap-4 items-center">
                                        <span className="px-3 py-1 glass rounded text-[10px] font-bold text-accent-cyan tracking-widest">{albums[index].genre}</span>
                                ...
                                <div className="grid grid-cols-2 gap-8 py-6 border-y border-white/5">
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 glass rounded-lg flex items-center justify-center text-accent-purple">
                                            <Music2 size={20} />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 glass rounded-lg flex items-center justify-center text-accent-blue">
                                            <Clock size={20} />
                                        </div>
                                        <div>
                                ...
                                <div className="flex gap-6 pt-4">
                                    <button className="flex-1 bg-white text-black font-black py-4 rounded-xl hover:bg-accent-purple hover:text-white transition-all duration-300 uppercase tracking-widest text-sm flex items-center justify-center gap-2 group">
                                        Listen Full Album <Play size={16} fill="currentColor" className="group-hover:translate-x-1 transition-transform" />
                                    </button>
                                    <button className="w-16 h-16 glass rounded-xl flex items-center justify-center border-white/10 hover:border-accent-purple/50 transition-all text-white hover:text-accent-purple group">
                                        ...
                                        {albums.map((_, i) => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    i === index ? "w-12 bg-accent-purple" : "w-4 bg-white/10"
                                                )}
                                            />
                                        ))}
                                    </div>
                                    <div className="flex ml-auto gap-3">
                                        <button onClick={prev} className="w-10 h-10 glass rounded-full flex items-center justify-center hover:bg-accent-purple/20 transition-colors border-white/5"><ChevronLeft size={18} /></button>
                                        <button onClick={next} className="w-10 h-10 glass rounded-full flex items-center justify-center hover:bg-accent-purple/20 transition-colors border-white/5"><ChevronRight size={18} /></button>
                                    </div>
                                </div>
                            </motion.div>
                        </AnimatePresence>
